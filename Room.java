			...
			if (e.getActionCommand().equals("ログアウト")) {
				...
				if (e.getSource() == b11) {
		            ...
		            try{
			            ...
			            client.ois = ois_room;
			            //cpu_battle.CPU_osero.j.setVisible(false);
					...
					if (room_player[1] == 1) {
						...
						//ルーム内に一人、CPU戦の開始
						System.out.println("start oserov4_cpu");
						Oserov4_cpu oserov4_cpu = new Oserov4_cpu();
						client.oserov4_cpu = oserov4_cpu;
						System.out.println("start CPU_thread");
						cpu_thread = new CPU_thread(client);
						cpu_thread.start();
					}
