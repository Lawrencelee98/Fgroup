    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println("Room [ " + String.valueOf(room_num) + " ] : time after random = "
                ...
                if (first_turn == 1) {
                    ...
                    while (battle_end) {
                        ...
                        if (data_1.get_protocol() == 3 || data_1.get_protocol() == 3000) {
                            System.out.println("player1 protocol: "+data_1.get_protocol());
                        ...
                        } else if (data_1.get_protocol() == 2000) {
                            transData timeout_win = new transData(2100);
                            os_2.writeObject(timeout_win);
                            transData timeout_lose = new transData(2000);
                            os_1.writeObject(timeout_lose);
                            break;
                        }else if (data_1.get_protocol() == 2100) {
                            transData timeout_win = new transData(2100);
                            transData timeout_lose = new transData(2000);
                            os_2.writeObject(timeout_lose);
                            os_1.writeObject(timeout_win);
                            break;
                        }else if(data_1.get_protocol()==2300){
                            transData draw = new transData(2300);
                            os_2.writeObject(draw);
                            os_1.writeObject(draw);
                            break;
                        }else if(data_1.get_protocol()==5000){
                            os_2.writeObject(data_1);
                            System.out.println("Room [ " + String.valueOf(room_num) + " ] " + "send Object to 2");
                        }
                        ...
                        if (data_2.get_protocol() == 3 || data_2.get_protocol() == 3000) {
                            System.out.println("player2 protocol: "+data_2.get_protocol());
                        ...
                        }else if (data_2.get_protocol() == 2000) {
                            System.out.println("os_2 get protocol 2000");
                            transData timeout_win = new transData(2100);
                            os_1.writeObject(timeout_win);
                            transData timeout_lose = new transData(2000);
                            os_2.writeObject(timeout_lose);
                            break;
                        }else if (data_2.get_protocol() == 2100) {
                            transData timeout_win = new transData(2100);
                            transData timeout_lose = new transData(2000);
                            os_2.writeObject(timeout_win);
                            os_1.writeObject(timeout_lose);
                            break;
                        }else if(data_2.get_protocol()==2300){
                            transData draw = new transData(2300);
                            os_2.writeObject(draw);
                            os_1.writeObject(draw);
                            break;
                        }else if(data_2.get_protocol()==5000){
                            os_1.writeObject(data_2);
                            System.out.println("Room [ " + String.valueOf(room_num) + " ] " + "send Object to 1");
                        }
                    }
                ...
                try {
                    ...
                    transData end_info2 = (transData)ois_2.readObject(); 
                    System.out.println("get end_info protocol 36");
                    transData temp_end_info = new transData(36);
                    if (end_info.get_protocol() == 36&&end_info2.get_protocol()==36) {
                        ...
                        }else if(end_info2.get_endinfo_draw()){
                            
                            temp_end_info.set_draw_result(name_p1, name_p2);
                        }else if(end_info2.get_endinfo_lose()){
